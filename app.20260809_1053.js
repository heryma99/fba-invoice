/* ============================================================
   ...
   ============================================================ */
'use strict';
const APP_VERSION = '20260809_1053'; // 每次部署必须更新，用于破坏浏览器缓存
...
async function verifyInvoice(buf, M, expectedFbaNo, expectedRows){
  ...
  if(boxCol){
    ...
    let n=0;
    for(let r=itemStartR; r<=ws.rowCount; r++){ const c=ws.getRow(r).getCell(boxColNum).value; if(c!==null && c!==undefined && String(c).trim()!=='') n++; }
