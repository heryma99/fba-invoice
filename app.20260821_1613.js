/* ============================================================
   ...
   ============================================================ */
'use strict';
const APP_VERSION = '20260821_1613'; // 每次部署必须更新，用于破坏浏览器缓存（20260821：修复 parseDeliveryAddress 邮编误杀——原要求邮编以数字开头(美国格式)，加拿大 V3M 5Y9/英国 B48 7JA 等字母开头邮编被清空导致 zip 必填校验报红，改为从尾部按固定位置解析）
