/* ============================================================
   ...
   ============================================================ */
'use strict';
const APP_VERSION = '20260917_2150'; // 每次部署必须更新，用于破坏浏览器缓存（20260917 A+B：①单图失败自动重试 IMG_RETRY=2 次——瞬时断流重试即成功，缺图率大降；②导出完成消息直接上屏缺图清单（SKU 去重+行数），不再只进 console；两段式超时/索引重试/blob.text 解析全部保留）
