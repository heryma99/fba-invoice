/* ============================================================
   ...
   ============================================================ */
'use strict';
const APP_VERSION = '20260917_2110'; // 每次部署必须更新，用于破坏浏览器缓存（20260917 四次修复：图源索引解析改 text()+JSON.parse——blob.json() 在老 Chromium 内核不存在(实测探针 Blob.prototype.json=undefined)导致索引永远空→整票零图；两段式超时+3次重试保留）
