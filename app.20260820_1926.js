/* ============================================================
   ...
   ============================================================ */
'use strict';
const APP_VERSION = '20260820_1926'; // 每次部署必须更新，用于破坏浏览器缓存（20260820：修复 MUL_SKU 小文件(如 1箱6SKU,16行)箱号/箱重识别失败——底部箱区扫描起始行 Math.min(rowCount,45) 对小文件只扫最后一行漏掉箱号行，改从表头后扫到底）
