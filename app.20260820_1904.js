/* ============================================================
   ...
   ============================================================ */
'use strict';
const APP_VERSION = '20260820_1904'; // 每次部署必须更新，用于破坏浏览器缓存（20260820：①新增亚马逊 MUL_SKU 混箱格式解析；②商品图嵌入前浏览器端压缩防 OOM——Shopify 外链原图 1-5MB/张，多票同驻内存必崩，现按图量三档压缩 1600/1200/900px JPEG，发票显示仅 64px 足够）
